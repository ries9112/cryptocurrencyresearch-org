...
Of course we can add other components that make a visualization effective, let's add labels to the chart now using [**xlab()**]{style="color: green;"} and [**ylab()**]{style="color: green;"}:
...
The [**ggplot2**]{style="color: #ae7b11;"} package comes with a large amount of functionality. You can find a full reference of the functions you can use here:
...
Awesome work! Move on to the [next section](#predictive-modeling) ➡️ to start making predictive models for the data.

...
<!--                             lm_test_predictions = map2(train_data, lm_test_predictions, last_train_price)) -->
<!-- ``` -->
...
<!--   head(tail(results, length(predictions)-1),length(predictions)-1) -->
<!-- } -->
<!-- ``` -->
...
<!-- cryptodata_nested <- mutate(cryptodata_nested, -->
<!--                             lm_test_predictions_t = map(lm_test_predictions, standardize_perc_change)) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- actuals_create <- function(test_data){ -->
<!--   as.numeric(unlist(select(test_data, price_usd))) -->
<!-- } -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- cryptodata_nested <- mutate(cryptodata_nested, -->
<!--                             actuals = ifelse(split < 5, -->
<!--                                              map(test_data, actuals_create), -->
<!--                                              map(holdout_data, actuals_create))) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- cryptodata_nested <- mutate(cryptodata_nested, -->
<!--                             actuals = map(actuals, actuals_perc_change)) -->
<!-- ``` -->
...
<!-- ```{r add_rmse} -->
<!-- cryptodata_nested <- mutate(cryptodata_nested, -->
<!--                             lm_rmse_test =  unlist(map2(lm_test_predictions, actuals, evaluate_preds_rmse)), -->

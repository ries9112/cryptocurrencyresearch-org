...
This is not very helpful however.
...
```{r}
metrics_historical <- pin_get(name = "crypto_tutorial_results_latest")
```
...
# First create grouped data
accuracy_over_time <- group_by(metrics_historical, last_refreshed)
# Now summarize the data
...
ggplot(accuracy_over_time, aes(x = last_refreshed, y = rmse, rsq = rsq)) +
  # Add both a red point and a red line for RMSE metric
  geom_point(color = 'red', size = 2) +
  geom_line(color = 'red', size = 1) +
  # Also add R^2 to the plot in dark green
  geom_point(aes(x = last_refreshed, y = rsq), color = 'dark green', size = 2) +
  geom_line(aes(x = last_refreshed, y = rsq), color = 'dark green', size = 1)
```

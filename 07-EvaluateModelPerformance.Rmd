...
full_holdout_preds <- union(lm_holdout_preds, xgb_holdout_preds, nnet_holdout_preds, rf_holdout_preds, pcr_holdout_preds)
```

<!-- And finally pin it so it can be read it by RStudio Server process -->

```{r upload_full_predictions_pin, eval=FALSE}
# register board
board_register("github", repo = "predictcrypto/pins", token=pins_key)
# Add current date time

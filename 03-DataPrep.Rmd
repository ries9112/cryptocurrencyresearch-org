...
As a final step before the next section let's double confirm that there are no NA values of [**date_time_utc**]{style="color: blue;"} and [**price_usd**]{style="color: blue;"} since without these two fields there is not much we can do as we need to know when the data was collected and what the price was:

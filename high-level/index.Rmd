...
[![Illustration by Allison Horst](C:/Users/ries9/Documents/Research-Paper-Example/images/ggplot2_masterpiece.png){width="47%"}](https://ggplot2.tidyverse.org/)
...
<small>
1. Take data from the past, where all columns are associated with a specific point in time, with the exception of the <span style="color: blue;">**Target24HourClose**</span> column, which represents the price of the cryptocurrency 24 hours in the future relative to the rest of the columns.
...
This ensures the "randomness" begins from the same starting point on your computer as it does in the example code being shown. [Click here to find out more about this idea](https://stats.stackexchange.com/questions/86285/random-number-set-seedn-in-r).

## set.seed() - continued

<!-- NOTE: IS THIS PROBLEMATIC? Is seed supposed to naturally keep moving? Does it need to be set before each step instead? (I think so?)-->
...
## Keep adding rest here!


# References

... Still need to finish adding websites/articles referenced here

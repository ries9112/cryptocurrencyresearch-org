...
<!-- ### Bayesian Ridge Regression Models - removed because of package conflict-->
...
<!-- Next let's create [Elastic Net](https://en.wikipedia.org/wiki/Elastic_net_regularization) models using the [**method**]{style="color: blue;"} [***`enet`***]{style="color: blue;"} -->

...
# Get the data
example_data <- httr::GET("https://api.hitbtc.com/api/2/public/orderbook/ETHUSD", query=list(limit=5))
# Show data
get_response_content(example_data)
```
